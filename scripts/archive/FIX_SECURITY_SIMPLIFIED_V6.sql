-- ============================================================================
-- SYSTÈME DE SÉCURITÉ SIMPLIFIÉ - VERSION 6
-- ============================================================================
        ...
        EXISTS (
            ...
            AND (
                ...
                (
                    ...
                    AND (
                        project_files.folder_path LIKE '%attachments%'
                        OR project_files.folder_path LIKE '%pieces-jointes%'
                    )
                )
            )
        )
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🔒 CLIENTS: Isolation totale - chaque client voit uniquement SES projets';
    RAISE NOTICE '👀 CANDIDATS AVEC BOOKING: Voient le projet et les pièces jointes';
    RAISE NOTICE '✅ CANDIDATS ACCEPTÉS: Accès complet (Kanban, Drive, Messages, Planning)';
    RAISE NOTICE '';
    RAISE NOTICE '📝 Statuts de booking:';
    RAISE NOTICE '   - pending/interested: accès limité (projet + pièces jointes)';
    RAISE NOTICE '   - accepted: accès complet';
    RAISE NOTICE '';

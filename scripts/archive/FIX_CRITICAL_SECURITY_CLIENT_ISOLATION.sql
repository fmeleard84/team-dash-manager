-- ============================================================================
-- CORRECTION CRITIQUE DE SÉCURITÉ : ISOLATION DES DONNÉES CLIENTS
-- ============================================================================
...
-- KANBAN_COLUMNS: Accès uniquement aux colonnes des projets possédés
...
-- KANBAN_CARDS: Accès uniquement aux cartes des projets possédés

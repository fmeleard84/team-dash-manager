...
CREATE TABLE IF NOT EXISTS template_categories (
  ...
  color varchar(50), -- Gradient color classes
...
CREATE TABLE IF NOT EXISTS project_templates (
  ...
  name varchar(255) NOT NULL,
  description text,
  reactflow_data jsonb NOT NULL, -- ReactFlow nodes and edges configuration
  estimated_duration integer, -- in days
  estimated_cost integer, -- in euros
...
-- Everyone can read templates (for display)

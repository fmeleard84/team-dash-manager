...
-- Replace existing policies with secure ones
...
DROP POLICY IF EXISTS "Candidates can view their own notifications via Keycloak" ON public.candidate_notifications;

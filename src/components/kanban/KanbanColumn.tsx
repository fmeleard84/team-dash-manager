...
export const KanbanColumn = ({ 
  ...
  return (
    <div className="flex flex-col w-80 min-h-[600px] bg-card rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-border/50 p-4 flex-shrink-0 hover:border-primary/30 group">
      {/* Column Header */}

...
export const KanbanBoard = ({
  ...
  return (
    <div className="flex flex-col h-full bg-background max-w-full">
      ...
      <div className="flex-1 overflow-x-auto overflow-y-visible max-w-full bg-gradient-to-br from-background via-background to-accent/20" style={{ position: 'relative', zIndex: 1 }}>
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="flex gap-4 p-4 min-h-full w-max" style={{ position: 'relative' }}>
            {board.columns
